...
def detuning(laser_wavelength, transition_wavelength):
    return 2 * pi * c * (1 / laser_wavelength - 1 / transition_wavelength)
...
def dipole_potential(det1, det2, linewidth1, linewidth2, sat_intensity1, sat_intensity2):
...
saturation_intensity_d1 = saturation_intensity(linewidth_d1, transition_wavelength_d1)
saturation_intensity_d2 = saturation_intensity(linewidth_d2, transition_wavelength_d2)

dipole_potential = dipole_potential(detuning_d1, detuning_d2,
                                    linewidth_d1, linewidth_d2,
                                    saturation_intensity_d1, saturation_intensity_d2)
