...
fig, ax = plt.subplots()
ax.loglog(m_list_holdover, np.sqrt(allan_var_holdover), 'b--', label='mode: holdover')
ax.loglog(m_list_holdover, np.sqrt(allan_var_holdover_dedrift), 'b', label='mode: holdover, dedrift corrected')
ax.loglog(m_list_gps, np.sqrt(allan_var_gps_), 'r--', label='mode: gps-disciplined')
ax.loglog(m_list_gps, np.sqrt(allan_var_gps_dedrift), 'r', label='mode: gps-disciplined, dedrift corrected')
