...
# user defined
from functions.conversion_functions import rdme_to_rate, rabi_freq_to_rate, wavelength_to_freq
from functions.formulas import beam_intensity
from functions.fitting_functions import fit_gr_dependence
...
popt_rdme, _ = curve_fit(fit_gr_dependence, n_values, rdme_values, [0.1, 0.1])
...
print('difference is sqrt(2) factor from collective rabi oscillation')
...
np.savetxt('calculations/Rydberg/data/rdme_values_fit.csv', rdme_values_fit, delimiter=',')
