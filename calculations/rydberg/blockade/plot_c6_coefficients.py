...
for n in n_values_plot:
    ...
    c6_array.append(c6)
    c6_overn11_array.append(c6_coefficient_overn11)

c6_overn11_array = np.array(c6_overn11_array)
...
ax3.plot(n_values_plot, blockade_radii, label='$w_x = 200$ $\mu$m, $w_y=20$ $\mu$m, $P=20$ mW')
