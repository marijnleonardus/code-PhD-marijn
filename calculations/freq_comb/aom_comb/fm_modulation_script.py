...
# sampling parameters
sample_overhead = 100  # how much higher sampling freq. is than carrier freq. 
...
def main():
    ...
    t_signal = RedMotDDS.linear_frequency_ramp(time_array)
        
    # Compute Fourier transform
    fft_signal = np.fft.fft(t_signal)
    ...
    lower_xlim = (carrier_freq - 1.5 * mod_depth)/mhz
    upper_xlim = (carrier_freq + 0.5 * mod_depth)/mhz
